...
/* package derive-2.5.18 */
#define VERSION_derive "2.5.18"
#define MIN_VERSION_derive(major1,major2,minor) (\
  (major1) <  2 || \
  (major1) == 2 && (major2) <  5 || \
  (major1) == 2 && (major2) == 5 && (minor) <= 18)
...
/* package template-haskell-util-0.1.1.0 */
#define VERSION_template_haskell_util "0.1.1.0"
#define MIN_VERSION_template_haskell_util(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
